...
import { unisexJewellery } from "../Data";


export default function UnisexSection() {
  return (
    <section className="w-full py-20 px-6 bg-white">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
        {unisexJewellery.map((item, index) => (
          <div
            key={index}
          ...
          >
            ...
            <div className="p-6 text-left">
              <h3 className="text-lg font-semibold text-[#00392E] mb-2">{item.name}</h3>
