...
function Footer() {
    return (
        <footer className="bg-[#e2f3f1] text-slate-800 pt-10 w-full">
            <div className="border-t border-slate-300"></div>

            <div className="max-w-6xl mx-auto px-4 py-10 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-8 text-sm">
                {/* Our Services */}
                <div>
                    ...
                    <ul className="space-y-2 text-xs text-slate-600">
                        <li>
                            ...
                            >
                                <MdOutlineCurrencyExchange className="text-yellow-600" /> GOLD
                                RATES
                            </a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a
                                ...
                                className="flex items-center gap-2 hover:text-yellow-600 transition"
                            >
                                <MdOutlinePayment className="text-indigo-600" /> VARIOUS PAYMENT
                                METHODS
                            </a>
                        </li>
                        <li>
                        ...
                        <li>
                            <a
                                ...
                                className="flex items-center gap-2 hover:text-yellow-600 transition"
                            >
                                <MdOutlineAssuredWorkload className="text-purple-600" /> GARNET
                                LANEE ASSURANCE
                            </a>
                        </li>
                        <li>
                    ...
                    <ul className="space-y-2 text-xs text-slate-600">
                        ...
                        <li>
                            <a
                                ...
                                className="flex items-center gap-2 hover:text-blue-600 transition"
                            >
                                <PiFilesDuotone className="text-purple-600" /> TERMS & CONDITIONS ON
                                OFFERS
                            </a>
                        </li>
                    </ul>
                ...
                <div>
                    ...
                    <div className="flex gap-3 text-lg mt-8 justify-center sm:justify-start">
                        <a
                            href="#"
                            className="w-8 h-8 rounded-full bg-slate-200 flex items-center justify-center hover:bg-teal-300 transition"
                            aria-label="Facebook"
                        >
                            <FaFacebookF />
                        </a>
                    ...
                    <div className="mt-8">
                        <h3 className="text-sm font-semibold mb-3 uppercase tracking-wide text-slate-700 text-center sm:text-left">
                            Download Our Application
                        </h3>

                        <div className="flex flex-col sm:flex-row justify-center sm:justify-start items-center gap-4 mt-4">
                            <a
                                href="https://play.google.com/store"
                                className="flex items-center gap-3 bg-black text-white px-4 py-3 rounded-2xl w-full max-w-[300px] sm:max-w-[360px] md:max-w-[460px] shadow-lg hover:shadow-xl transition-all duration-200"
                            ...
                            >
                                ...
                                <div className="flex flex-col text-left">
                                    <span className="text-[11px] sm:text-xs text-gray-300 tracking-widest font-medium uppercase sm:whitespace-nowrap whitespace-normal">
                                        GET IT ON
                                    </span>
                                    <span className="text-lg sm:text-2xl font-semibold leading-tight sm:whitespace-nowrap whitespace-normal">
                                        Google Play
                                    </span>
                                </div>
                            </a>
